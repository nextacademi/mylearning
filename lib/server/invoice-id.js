...
// change needed.
// Exported so lib/server/invoice-core.js's manual (non-enrollment)
// invoices draw from this SAME per-year sequence — one gap-free,
// non-colliding INV-{year}-##### numbering scheme academy-wide, not a
// second counter that could collide with enrollment invoice numbers.
export async function nextInvoiceNumber(db, year) {
