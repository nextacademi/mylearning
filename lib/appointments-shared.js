...
// What the appointment is for, and how the Admin panel labels its lifecycle
// status. "booked" is stored as-is (unchanged — see slotKey's uniqueness
// lock above, which keys off status !== "cancelled") but now displays as
// "Upcoming"; "completed" is new, set via the Admin panel's explicit
// "Mark as Completed" action.
export const APPOINTMENT_PURPOSES = ["Consultation", "Admission", "Counselling", "Other"];
export const APPOINTMENT_STATUS_LABEL = { booked: "Upcoming", completed: "Completed", cancelled: "Cancelled" };
