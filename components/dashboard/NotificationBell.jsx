...
import { Bell, BellRing, CalendarClock, CircleDollarSign, MessageCircle, UserCheck, CheckCheck, UserX } from "lucide-react";
...
const typeIcon = {
  ...
  appointment: { Icon: CalendarClock, bg: "bg-info-soft", color: "text-info" },
